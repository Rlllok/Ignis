...
func VkShaderStageFlags   RHI_VK_GetVkShaderStage(RHI_ShaderKind shader_kind);
func VkDescriptorType     RHI_VK_GetVkDescriptorType(RHI_BindingKind binding_kind);
func U32                  RHI_VK_FindMemoryTypeIndex(U32 type_filter, VkMemoryPropertyFlags property_flags);
func void                 RHI_VK_TransitImageLayout(VkCommandBuffer cmd, VkImage image, VkImageLayout layout, VkImageLayout new_layout, VkAccessFlags srs_access, VkAccessFlags dst_access, VkPipelineStageFlags src_stage, VkPipelineStageFlags dst_stage, VkImageAspectFlags apect_mask);
...
func VkFilter             RHI_VK_GetVkFilter(RHI_FilterKind filter);
