...
RHI_VK_GetVkAttachmentLoadOperation(RHI_LoadOperation operation) {
  ...
  switch (operation) {
    ...
    case RHI_AttachmentLoadOperation_DontCare: result = VK_ATTACHMENT_LOAD_OP_DONT_CARE; break;
    case RHI_AttachmentLoadOperation_Load:     result = VK_ATTACHMENT_LOAD_OP_LOAD; break;
    case RHI_AttachmentLoadOperation_Clear:    result = VK_ATTACHMENT_LOAD_OP_CLEAR; break;
  }
  return result;
}
