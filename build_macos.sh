...
if [ "$1" == "string" ]; then time clang -g ./code/app/string.c -o build/string $warnings $defines $include_flags; fi
if [ "$1" == "macos"  ]; then time clang -g ./code/app/macos.c  -o build/macos  $warnings $defines $include_flags; fi
