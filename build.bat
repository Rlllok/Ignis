...
set clang_flags=-DIGNIS_DEBUG -Wall %clang_turnoff_warnings% -fuse-ld=lld -pedantic -fms-runtime-lib=dll_dbg -g -I..\code\ -L..\code\
...
pushd build
    if "%main%" == "1" %compiler% %clang_flags% ..\code\app\main.cpp -o main.exe
popd
